...
class DemandMonitorCommand extends Command
{
    ...
    {
        $this
            ->addOption('source', 's', InputOption::VALUE_REQUIRED, 'Source(s) to monitor: poptavky_cz, aaapoptavka, poptavej, webtrh, nen, jobs_cz, prace_cz, startup_jobs, all (comma-separated)')
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        if (empty($sourcesToUse)) {
            $io->error('No valid sources specified. Use: poptavky_cz, aaapoptavka, poptavej, webtrh, nen, jobs_cz, prace_cz, startup_jobs, or all');
